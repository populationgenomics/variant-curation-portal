# Generated by Django 2.2.24 on 2023-01-13 00:10
...
class Migration(migrations.Migration):
    dependencies = [
        ("curation_portal", "0012_auto_20230112_0225"),
    ]
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                message="Flag shortcut must be 2 uppercase alphanumeric characters, and not start with a number.",
                                regex="[A-Z]{1}[A-Z0-9]{1}",
                            )
                        ],
                    ),
                ),
